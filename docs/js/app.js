...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dataCrawler_DataCrawler__ = __webpack_require__(5);
 ...
 */
PivotBuilder.prototype.getRowsArray = function (data, rowNames) {
    let result = [];
 ...
 * @returns {Array}
 */
PivotBuilder.prototype.findMatched = function (data, fields, values) {
    let result = [];
 ...
 */
PivotBuilder.prototype.pivotResultsRaw = function (data, rowNames, colNames) {
    let result = [];
 ...
 */
PivotBuilder.prototype.calculateResults = function (rawResultsTable, callback) {
    let refinedResults = [];
 ...
 * @returns {Element}
 */
PivotBuilder.prototype.composeTHead = function (rowNames, colNames, cols) {
    ...
    for (let colInnerIdx in colNames) {
        ...
        let colspan = 1;
        cols.map(function (rowVal, i) { // header prop values
 ...
 * @returns {Element}
 */
PivotBuilder.prototype.composeTBody = function (results, rows) {
 ...
 * @returns {HTMLElement}
 */
PivotBuilder.prototype.renderFknTable = function (data, rowNames, colNames, calculateResultCallback) {
